...
export default function AboutBuiltBy() {
  return (
    <section
      id="about"
      className="rounded-2xl border border-white/10 bg-surface/60 p-7 backdrop-blur-sm"
    >
      ...
      <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-muted">
        ...
        official YouTube Data API and layers growth, niche-demand forecasting,
        clustering, and an engagement-risk model on top — so creators understand
        their standing and brands shortlist with eyes open. It runs on a free,
        open stack and is built and maintained by{" "}
